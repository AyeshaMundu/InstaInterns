...
io.sockets.on('connection',function(socket){
        ...
        socket.on('disconnect',function(data)
        {
          ...
          {
              //io.sockets.emit('agent_disconnect',socket.nickname);
          ...
          else if(visitors[socket.nickname])
          {
            console.log("this is array wala loop");
              ...
              for(var i=0;i<pair.length;i++)
              {
                ...
                {
                  visitors[socket.nickname].emit('visitor_disconnect',pair[i].v1);
        ...
        socket.on('amsg',function(data,data1)
        {
          ...
          for(var i=0;i<pair.length;i++)
           ...
           //visitors[socket.nickname].emit('ag_to_s',data,data1);
        });
